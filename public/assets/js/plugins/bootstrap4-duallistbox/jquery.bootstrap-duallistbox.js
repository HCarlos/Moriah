...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: '<h6><span class="badge badge-pill badge-secondary">Mostrando  <span class="badge badge-light">{0}</span></span></h6>',                                                        // text when all options are visible / false for no info text
      ...
      infoTextEmpty: '<h6><span class="badge badge-pill badge-secondary">Lista vacia</span></h6>',                                                        // when there are no options present in the list
      ...
      btnClass: '',                                                  // sets the button style class for all the buttons
      btnMoveText: 'Mover uno',                                                                // string, sets the text for the "Move" button
      btnRemoveText: 'Remover uno',                                                              // string, sets the text for the "Remove" button
      btnMoveAllText: 'Mover todo',                                                         // string, sets the text for the "Move All" button
      btnRemoveAllText: 'Remover todo'                                                        // string, sets the text for the "Remove All" button
    },
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        '     <button type="button" class="btn moveall" style="background-color:#BA9862; color:white;"></button>' +
        '     <button type="button" class="btn move" style="background-color:#BA9862; color:white;"></button>' +
        '   </div>' +
        ...
        '   <input class="form-control filter" type="text">' +
        '   <div class="btn-group buttons">' +
        '     <button type="button" class="btn removeall" style="background-color:#A22145; color:white;"></button>' +
        '     <button type="button" class="btn remove" style="background-color:#A22145; color:white;"></button>' +
        '   </div>' +
        '   <select multiple="multiple"></select>' +
        ' </div>' +
        '</div>')
