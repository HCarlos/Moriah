...
//        Route::get('/catajax/{id}', 'Catalogos\CatalogosListController@ajaxIndex')->name('ajaxIndexCatList');
    ...
    Route::get('/tarjeta_movtos_prod/{producto_id}/{opt}', 'Externos\TarjetaMovtosController@imprimir_tarjeta_movtos')->name('imprimirTarjetasMovto/');
    Route::get('/imprimir_tarjeta_movtos_costeo/{producto_id}', 'Externos\TarjetaMovtosController@imprimir_tarjeta_movtos_costeo')->name('imprimir_tarjeta_movtos_costeo/');
