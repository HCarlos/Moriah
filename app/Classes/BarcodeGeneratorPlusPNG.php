...
class BarcodeGeneratorPlusPNG {
     ...
     * @protected
     */
    protected function barcode_code93($code): array
    {
        $chr = [];
        $chr[48] = '131112'; // 0
        $chr[49] = '111213'; // 1
     ...
     * @protected
     */
    protected function checksum_code93($code): string
    {
        $chars = array(
            '0',
            '1',
     ...
     * @protected
     */
    protected function checksum_s25($code): int
    {
        $len = strlen($code);
        $sum = 0;
        for ($i = 0; $i < $len; $i += 2) {
     ...
     * @protected
     */
    protected function barcode_msi($code, $checksum = false): array
    {
        $chr['0'] = '100100100100';
        $chr['1'] = '100100100110';
        $chr['2'] = '100100110100';
     ...
     * @protected
     */
    protected function barcode_s25($code, $checksum = false): array
    {
     ...
     * @protected
     */
    protected function binseq_to_array($seq, $bararray): array
    {
        $len = strlen($seq);
        $w = 0;
        $k = 0;
     ...
     * @protected
     */
    protected function barcode_i25($code, $checksum = false): array
    {
        $chr['0'] = '11221';
        $chr['1'] = '21112';
        $chr['2'] = '12112';
     ...
     * @protected
     */
    protected function barcode_c128($code, $type = ''): array
    {
        $chr = array(
            '212222', /* 00 */
            '222122', /* 01 */
...
//                $bararray['maxw'] += $w;
     ...
     * @protected
     */
    protected function barcode_eanupc($code, $len = 13): array
    {
        $upce = false;
        if ($len == 6) {
            $len = 12; // UPC-A
     ...
     * @protected
     */
    protected function barcode_eanext($code, $len = 5): array
    {
        //Padding
     ...
     * @protected
     */
    protected function barcode_postnet($code, $planet = false): array
    {
        // bar length
        if ($planet) {
            $barlen = Array(
     ...
     * @protected
     */
    protected function barcode_rms4cc($code, $kix = false): array
    {
        $notkix = ! $kix;
        // bar mode
        // 1 = pos 1, length 2
     ...
     * @protected
     */
    protected function barcode_codabar($code): array
    {
        $chr = array(
            '0' => '11111221',
            '1' => '11112211',
...
//                $bararray['maxw'] += $w;
     ...
     * @protected
     */
    protected function barcode_code11($code): array
    {
        $chr = array(
            '0' => '111121',
            '1' => '211121',
...
//                $bararray['maxw'] += $w;
     ...
     * @protected
     */
    protected function barcode_pharmacode($code): array
    {
        $seq = '';
        $code = intval($code);
        while ($code > 0) {
     ...
     * @protected
     */
    protected function barcode_pharmacode2t($code): array
    {
        $seq = '';
        $code = intval($code);
        do {
     ...
     * @protected
     */
    protected function barcode_imb($code): array
    {
        $asc_chr = array(
            4,
            0,
     ...
     * @protected
     */
    protected function barcode_imb_pre($code): array
    {
     ...
     */
    protected function dec_to_hex($number): string
    {
        if ($number == 0) {
            return '00';
        }
     ...
     * @protected
     */
    protected function imb_crc11fcs($code_arr): int
    {
     ...
     * @protected
     */
    protected function imb_reverse_us($num): int
    {
        $rev = 0;
        for ($i = 0; $i < 16; ++$i) {
            $rev <<= 1;
     ...
     * @protected
     */
    protected function imb_tables($n, $size): array
    {
        $table = array();
