...
@section('main-content')
    <div class="panel panel-moriah" id="catalogosList0">
        <div class="panel-heading">
            ...
            <a href="{{ route('paqueteNew', array('idItem' => 0)) }}" class="btn btn-info btn-xs" target="_blank" title="Agregar nuevo registro">
                ...
                @if ($items)
                    <table id="{{ $tableName}}" class="table table-striped table-bordered table-hover dataTable" >
                        ...
                        <tr role="row">
                            ...
                            <th aria-label="GpoPS" style="width: 50px;" colspan="1" rowspan="1" aria-controls="{{ $tableName}}" tabindex="5" role="columnheader" class="sorting text-right">Grupos</th>
                        ...
                        @foreach ($items as $item)
                            <tr>
                                ...
                                <td class="text-right">{{ $item->grupos_platsource}} </td>
                                <td >
