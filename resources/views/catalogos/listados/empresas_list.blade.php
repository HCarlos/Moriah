...
@section('main-content')
    <div class="panel panel-moriah" id="catalogosList0">
        <div class="panel-heading">
            ...
            <a href="{{ route('empresaNew', array('idItem' => 0)) }}" class="btn btn-info btn-xs " target="_blank" title="Agregar nuevo registro">
                <i class="fa fa-plus-circle bigger-150"></i>
            </a>
            <a href="{{ route('empresaIndex', array('npage' => 1, 'tpaginas' => 0)) }}" class="btn btn-info btn-xs " title="Actualizar">
