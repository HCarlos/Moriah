...
@section('main-content')
    <div class="panel panel-moriah" id="catalogosList0">
        <div class="panel-heading">
            ...
            <a href="{{ route('almacenNew', array('idItem' => 0)) }}" class="btn btn-info btn-sm " target="_blank" title="Agregar nuevo registro">
                <i class="fa fa-plus-circle "></i>
            </a>
            <a href="{{ route('almacenIndex', array('npage' => 1, 'tpaginas' => 0)) }}" class="btn btn-info btn-sm " title="Actualizar">
