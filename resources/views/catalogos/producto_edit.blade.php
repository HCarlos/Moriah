    ...
    <div class="panel-body">
                    <form method="post" action="{{ action('SIIFAC\ProductoController@update',['prod'=>$items]) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                {{ Form::select('almacen_id', $Almacenes, $items->almacen_id, ['id' => 'almacen_id']) }}
                            </div>
                            <label for = "familia_producto_id" class="col-md-1 col-form-label text-md-left">Categoría</label>
                            <div class="col-md-2">
                                {{ Form::select('familia_producto_id', $FamProds, $items->familia_producto_id, ['id' => 'familia_producto_id']) }}
                            </div>
                            <label for = "medida_id" class="col-md-1 col-form-label text-md-left">Medida</label>
                            <div class="col-md-2">
                                {{ Form::select('medida_id', $Medidas, $items->medida_id, ['id' => 'medida_id']) }}
                            </div>
