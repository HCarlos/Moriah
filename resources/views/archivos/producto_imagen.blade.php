            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-moriah center-block" id="frmEditProfile1">
                    <div class="panel-heading">
                            <span><strong>Imagen del Producto | {{$user->username}}</strong>
                            </span>
                    </div>
                    <div class="panel-body">

                        <form method="post" action="{{ action('Storage\StorageProductoController@subirArchivoProducto',['oProducto'=>$item]) }}" accept-charset="UTF-8" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                        ...
                                        <div class="list-group-item col-md-5" >
                                            ...
                                            @else
                                                <a href="{{ asset('storage/'.$item->root.$item->filename)  }}" target="_blank" >
                                                    ...
                                                    <a href="{{ route('storageProductoRemove/',array('idItem' => $item->id))  }}"  class="mi-imagen-arriba-derecha fa fa-trash bigger-150 red" >
